...
public class AirportTest {
    ...
    public void testGetTransportMilitaryPlane() {
        Assert.assertEquals(MilitaryType.TRANSPORT, new Airport(planes).getTransportMilitaryPlanes().get(1).getType());
    }
    ...
    public void testHasAtLeastOneBomberInMilitaryPlanes() {
        Assert.assertTrue(new Airport(planes).checkHasAtLeastOneBomberInMilitaryPlanes());
    }

    @Test
    public void testExperimentalPlanesHasClassificationLevelHigherThanUnclassified(){
        Assert.assertTrue(new Airport(planes).checkExperimentalPlanesHasClassificationLevelHigherThanUnclassified());
    }
}
